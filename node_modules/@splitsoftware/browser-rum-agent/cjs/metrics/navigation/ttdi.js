...
exports.getTTDI = exports.calculateTTDI = void 0;
/**
 ...
 */
var simpleMetricFactory_1 = require("./simpleMetricFactory");
...
exports.calculateTTDI = calculateTTDI;
exports.getTTDI = (0, simpleMetricFactory_1.simpleMetricFactory)('time.to.dom.interactive', calculateTTDI);
